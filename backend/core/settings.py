...
SECRET_KEY = 'django-insecure-@rp)k8ead-fkzwrm*@lw6lmquj__8@3*35^wt-7&2!elgm3r(&'
...
# Students stay logged in for 7 days without interruption.
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': False,              # No blacklist needed for now
...
# Support both naming conventions in .env (OPEN_ROUTER_API_KEY or OPENROUTER_API_KEY)
